/**
 * Add TCHS Soccer Direct Stream Links for February 24, 2026 (public)
...
const streams = [
  {
    slug: 'tchs/soccer-20260224-jv2',
    title: 'TCHS Soccer JV2 - February 24, 2026',
    homeTeamName: 'TCHS JV2',
  },
  {
    slug: 'tchs/soccer-20260224-jv',
    title: 'TCHS Soccer JV - February 24, 2026',
    homeTeamName: 'TCHS JV',
  },
  {
    slug: 'tchs/soccer-20260224-varsity',
    title: 'TCHS Soccer Varsity - February 24, 2026',
...
async function main() {
  ...
  const scheduledAt = new Date('2026-02-24T19:00:00Z');
  ...
  console.log('   https://fieldview.live/direct/tchs/soccer-20260224-jv2');
  console.log('   https://fieldview.live/direct/tchs/soccer-20260224-jv');
  console.log('   https://fieldview.live/direct/tchs/soccer-20260224-varsity\n');
}
