/**
 * Add TCHS Soccer Direct Stream Links for February 20, 2026 (public)
...
const streams = [
  {
    slug: 'tchs/soccer-20260220-jv2',
    title: 'TCHS Soccer JV2 - February 20, 2026',
    homeTeamName: 'TCHS JV2',
  },
  {
    slug: 'tchs/soccer-20260220-jv',
    title: 'TCHS Soccer JV - February 20, 2026',
    homeTeamName: 'TCHS JV',
  },
  {
    slug: 'tchs/soccer-20260220-varsity',
    title: 'TCHS Soccer Varsity - February 20, 2026',
...
async function main() {
  ...
  const scheduledAt = new Date('2026-02-20T19:00:00Z');
  ...
  console.log('   https://fieldview.live/direct/tchs/soccer-20260220-jv2');
  console.log('   https://fieldview.live/direct/tchs/soccer-20260220-jv');
  console.log('   https://fieldview.live/direct/tchs/soccer-20260220-varsity\n');
}
