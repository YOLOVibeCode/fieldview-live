/**
 * Add TCHS Soccer Direct Stream Links for February 10, 2026
 * Creates direct stream links for JV2, JV, and Varsity teams
 * 
 * Usage:
 *   Local:      DATABASE_URL="postgresql://..." pnpm exec tsx scripts/add-tchs-soccer-20260210.ts
 *   Production: DATABASE_URL="<production-url>" pnpm exec tsx scripts/add-tchs-soccer-20260210.ts
 * 
...
const streams = [
  {
    slug: 'tchs/soccer-20260210-jv2',
    title: 'TCHS Soccer JV2 - February 10, 2026',
    homeTeamName: 'TCHS JV2',
  },
  {
    slug: 'tchs/soccer-20260210-jv',
    title: 'TCHS Soccer JV - February 10, 2026',
    homeTeamName: 'TCHS JV',
  },
  {
    slug: 'tchs/soccer-20260210-varsity',
    title: 'TCHS Soccer Varsity - February 10, 2026',
...
async function main() {
      ...
      if (existing) {
        ...
        if (!game) {
          game = await prisma.game.create({
            data: {
              ...
              awayTeam: 'TBD',
              startsAt: new Date('2026-02-10T19:00:00Z'), // Feb 10, 2026 7pm
              priceCents: 0,
              currency: 'USD',
        ...
        await prisma.directStream.create({
          data: {
            ...
            scheduledStartAt: new Date('2026-02-10T19:00:00Z'),
  ...
  console.log('   • https://fieldview.live/direct/tchs/soccer-20260210-jv2');
  console.log('   • https://fieldview.live/direct/tchs/soccer-20260210-jv');
  console.log('   • https://fieldview.live/direct/tchs/soccer-20260210-varsity\n');
}
