/**
 * Add TCHS Soccer Direct Stream Links for February 13, 2026 (public)
...
const streams = [
  {
    slug: 'tchs/soccer-20260213-jv2',
    title: 'TCHS Soccer JV2 - February 13, 2026',
    homeTeamName: 'TCHS JV2',
  },
  {
    slug: 'tchs/soccer-20260213-jv',
    title: 'TCHS Soccer JV - February 13, 2026',
    homeTeamName: 'TCHS JV',
  },
  {
    slug: 'tchs/soccer-20260213-varsity',
    title: 'TCHS Soccer Varsity - February 13, 2026',
...
async function main() {
  ...
  const scheduledAt = new Date('2026-02-13T19:00:00Z');
  ...
  console.log('   https://fieldview.live/direct/tchs/soccer-20260213-jv2');
  console.log('   https://fieldview.live/direct/tchs/soccer-20260213-jv');
  console.log('   https://fieldview.live/direct/tchs/soccer-20260213-varsity\n');
}
